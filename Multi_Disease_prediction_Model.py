# -*- coding: utf-8 -*-
"""
Created on Tue Oct 22 15:25:20 2024
...
diabetes_model = pickle.load(open('D:/Academics/ML Projects/Multple_Disease_Prediction/diabetes_model.sav','rb'))

heart_disease_model = pickle.load(open('D:/Academics/ML Projects/Multple_Disease_Prediction/heart_disease_model.sav','rb'))

parkinsons_disease_model = pickle.load(open('D:/Academics/ML Projects/Multple_Disease_Prediction/parkinsons_model.sav','rb'))
...
# Parkinsons Disease Prediciton page
if(selected == 'Parkinsons Disease Prediciton'):
